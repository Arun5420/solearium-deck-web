const phaseIcons = [
  ...
  <svg key="p2" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="3" y="27" width="23" height="13" rx="2" stroke="#0d0d0d" strokeWidth="2.5" fill="none"/>
    <path d="M26 32 L26 27 L35 27 L43 32 L43 40 L26 40" stroke="#0d0d0d" strokeWidth="2.5" fill="none" strokeLinejoin="round"/>
    ...
    <path d="M11 4 C11 1 15 1 15 4 C15 7 13 10 13 10 C13 10 11 7 11 4 Z" stroke="#0d0d0d" strokeWidth="2" fill="none"/>
    ...
    <path d="M20 2 C20 -1 24 -1 24 2 C24 5 22 8 22 8 C22 8 20 5 20 2 Z" stroke="#0d0d0d" strokeWidth="2" fill="none"/>
    ...
    <path d="M31 4 C31 1 35 1 35 4 C35 7 33 10 33 10 C33 10 31 7 31 4 Z" stroke="#0d0d0d" strokeWidth="2" fill="none"/>
  ...
  return (
    <section className="section">
      <div className="slide-container z-10">
        ...
        {/* align-items: stretch ensures all 3 columns (and therefore all cards) reach the same height */}
        <div
          className="grid grid-cols-1 lg:grid-cols-3 gap-8"
          style={{ alignItems: "stretch" }}
        >
          {phases.map((p, i) => (
            /* flex column so the content box can flex-grow to fill remaining height */
            <div key={i} style={{ display: "flex", flexDirection: "column" }}>
              ...
              {/* Content box — flex: 1 stretches to match the tallest card */}
              <div
                style={{
